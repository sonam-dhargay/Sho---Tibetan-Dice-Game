          ...
          <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
            ...
            <div className="flex flex-col items-center gap-6 text-center">
              <div className="space-y-3">
                <h3 className={`text-xl font-cinzel ${isDarkMode ? 'text-white' : 'text-stone-900'} font-bold leading-tight uppercase tracking-wider`}>
                  Sho Pro
                </h3>
                <p className="text-stone-500 font-serif text-sm leading-relaxed max-w-xs mx-auto">
                  {T.menu.aboutDesc.bo}
                </p>
